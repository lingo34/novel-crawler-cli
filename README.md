...
我最近发现，有一部我很久很久以前喜欢的一个小说，莫名其妙被弄没了，再也找不到了。在这个中心化的互联网结构下，你曾经喜欢或甚至付费阅读的的小说有可能因为各种原因，如网站倒闭，不可抗力等因素消失。因此，数据备份是十分有必要的。

不过如果大家都用爬虫爬取小说网站，想必会对小说网站造成不小的负担。这不好。因此，我提议，加入我们的[telegram](https://t.me/+akoDsm2PIZ8xM2Vh)交流群，分享已经有人爬取过的小说吧。或是把你爬取过的小说提交到 [lingo34/xsbk](https://github.com/lingo34/xsbk) 或是给我发email `lingo34@skiff.com`，一起薅资本主义的羊毛，来为中国网络文学的留存做一份贡献吧。
